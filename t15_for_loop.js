...
function verse(){
  OUTPUT.innerHTML += "<p>Verse number</p>";
}
verse()
...
userNumber = SONG_FIELD.value;
  OUTPUT.innerHTML += "<p>"+userNumber+"Bottles of milk on the wall,"+userNumber+" bottles of milk, if one of those bottles should accidentally fall...There'd be </p>";
